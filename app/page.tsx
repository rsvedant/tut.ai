                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                            <div className="lg:w-1/2">
                                ...
                                >
                                    ...
                                    personalized AI tutors across any subject.
                                    Get instant answers, explanations, and
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12">
                            ...
                            >
                                ...
                                learning experiences that adapt to your unique
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <p className="text-zinc-600 dark:text-zinc-400">
                                    Choose from a wide range of academic
                            ...
                            >
                                ...
                                <p className="text-zinc-600 dark:text-zinc-400">
                                    Begin your learning journey with
                                    personalized AI-powered tutoring.
                                </p>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12">
                            ...
                            >
                                ...
                                Here&apos;s what students and educators have to
                                say about tut.ai.
                            </motion.p>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            >
                                ...
                                benefiting from our AI-powered tutoring
                                platform.
                            </motion.p>
                            <motion.div
